...
print("CODE USAGE:")
print("python LIGHTING_I2C_DIMMING_TRANSIENT.py 46 120,230,277 1,2")
print("<LED load> <Input Voltage> <Test List>")
...
def i2c_dimming(start=0, end=254, voltage=120, frequency=60, LED=46, cp=0,
    ...
    # print(f"Turn on AC: {voltage} Vac")
    ac.voltage = voltage
