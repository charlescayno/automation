...
test = f"SR FET Vds Ids Steady-State"
unit = 7
...
def main():
    ...
    for vout1, iout1 in load_list_1:
        for vout2, iout2 in load_list_2:
            ...
            EQUIPMENT_FUNCTIONS().ELOAD_CC_ON(EQUIPMENT_ADDRESS.ELOAD_CHANNEL_1, 1)
            EQUIPMENT_FUNCTIONS().ELOAD_CC_ON(EQUIPMENT_ADDRESS.ELOAD_CHANNEL_2, 1)
