...
vin_list = [120,230]
# vin_list = [230]
test = "Timing Diagram with ZCD_OUT"
...
def scope_settings():
    ...
    scope.channel_settings(state='ON', channel=3, scale=2, position=-4, label="Relay ON pulse", color='GREEN', rel_x_position=50, bandwidth=20, coupling='DCLimit', offset=0)
    # scope.channel_settings(state='ON', channel=4, scale=1, position=0, label="Input Current", color='BLUE', rel_x_position=70, bandwidth=20, coupling='DCLimit', offset=0)
