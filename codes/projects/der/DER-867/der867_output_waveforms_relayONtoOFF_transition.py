...
test = "Output Waveforms, Relay ON to OFF transition"
...
def scope_settings():
    ...
    scope.channel_settings(state='ON', channel=4, scale=2, position=-2, label="Relay OFF pulse", color='BLUE', rel_x_position=90, bandwidth=20, coupling='DCLimit', offset=0)
    
    scope.edge_trigger(4, 2,'NEG')
...
def operation():
    ...
    for vin in vin_list:
        ...
        input("OFF relay. Press enter to continue...")
