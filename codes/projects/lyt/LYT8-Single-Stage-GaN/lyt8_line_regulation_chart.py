...
def anchor_picker(ws_name, chart, data_length=101, led_row=[3,106,209], x_axis_col=['C', 'T', 'AK', 'BB'], y_axis_col=['M', 'AD', 'AU', 'BL']):
    ...
    x_col = x_axis_col[0]
    y_col = y_axis_col[0]
    append_series(full_path, wb, ws_name, x_anchor=f"{x_col}{row}", last_row_anchor=f"{y_col}{data_length+row-1}", series_title="75 W", chart=chart)
...
def create_chart_from_test_name_sheet(ws_name, title, x_title, data_row, x_axis_col, y_axis_col,
    ...
    anchor_picker("Line Regulation", chart, data_length=data_length, led_row=data_row, x_axis_col=x_axis_col, y_axis_col=y_axis_col)
...
def operation():
    ...
    ws_name = "Line Regulation"

    create_chart_from_test_name_sheet(ws_name, title="Output Current (mA)", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['J'],
    ...
    create_chart_from_test_name_sheet(ws_name, title="Power Factor", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['G'],
                                            x_min_scale=90, x_max_scale=300, x_major_unit=15, x_minor_unit=15,
    ...
    create_chart_from_test_name_sheet(ws_name, title="THD (%)", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['H'],
                                            x_min_scale=90, x_max_scale=300, x_major_unit=15, x_minor_unit=15,
    ...
    create_chart_from_test_name_sheet(ws_name, title="Efficiency (%)", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['N'],
                                            x_min_scale=90, x_max_scale=300, x_major_unit=15, x_minor_unit=15,
    ...
    create_chart_from_test_name_sheet(ws_name, title="Output Voltage Regulation (%)", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['L'],
                                        x_min_scale=90, x_max_scale=300, x_major_unit=15, x_minor_unit=15,
                                        y_min_scale=-1, y_max_scale=10, y_major_unit=1, y_minor_unit=1,
                                        data_length=500, style=2, chart_col_location='AL', chart_row_location=2)

    create_chart_from_test_name_sheet(ws_name, title="Output Voltage (V)", x_title='Input Voltage (VAC)', data_row=[3], x_axis_col=['B'], y_axis_col=['I'],
                                        x_min_scale=90, x_max_scale=300, x_major_unit=15, x_minor_unit=15,
