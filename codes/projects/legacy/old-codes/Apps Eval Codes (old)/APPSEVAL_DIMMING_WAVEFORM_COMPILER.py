# print("Charles Cayno | 27-Jun-2021")
# print("PURPOSE: To have a general python file for compilation of waveforms")

# print()
# print("Features:")
# print("- Not dependent on the number of waveforms")
# print("- One tab per condition")
# print()

import os

directory = f"{os.getcwd()}\\waveforms\\Analog Dimming\\46V 277Vac"
