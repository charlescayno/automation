...
for voltage, frequency in zip(voltages, frequencies):
  ...
  #     scope1.get_screenshot(filename=f'{voltage}Vac___A [{Po1}W] {vout1}V {iout1}A ({current_name_1[0]}Load)___B [{Po2}W] {vout1}V {iout2}A ({current_name_2[0]}Load)___PortA.png', path=f'{waveforms_folder}')
  #     print(f'{voltage}Vac___A [{Po1}W] {vout1}V {iout1}A ({current_name_1[0]}Load)___B [{Po2}W] {vout1}V {iout2}A ({current_name_2[0]}Load)___PortA.png')
  #     waveform_counter = waveform_counter + 1
  #     # sleep(1)
  #     scope2.get_screenshot(filename=f'{voltage}Vac___A [{Po1}W] {vout1}V {iout1}A ({current_name_1[0]}Load)___B [{Po2}W] {vout1}V {iout2}A ({current_name_2[0]}Load)___PortB.png', path=f'{waveforms_folder}')
  #     print(f'{voltage}Vac___A [{Po1}W] {vout1}V {iout1}A ({current_name_1[0]}Load)___B [{Po2}W] {vout1}V {iout2}A ({current_name_2[0]}Load)___PortB.png')
  #     waveform_counter = waveform_counter + 1
  ...
  for vout3, iout3 in zip(Vo3, Imax3):
    ...
    if port == 'A':
      ...
      scope2.run_single()
      sleep(6)
      scope1.get_screenshot(filename=f'{voltage}Vac___A [65W] {vout3}V 100Load___B [0W]___PortA.png', path=f'{waveforms_folder}')
      print(f'{voltage}Vac___A [65W] {vout3}V 100Load___B [0W]___PortA.png')
      waveform_counter = waveform_counter + 1
      scope2.get_screenshot(filename=f'{voltage}Vac___A [65W] {vout3}V 100Load___B [0W]___PortB.png', path=f'{waveforms_folder}')
      print(f'{voltage}Vac___A [65W] {vout3}V 100Load___B [0W]___PortB.png')
      waveform_counter = waveform_counter + 1
    ...
    if port == 'B':
      ...
      scope2.run_single()
      sleep(6)
      scope1.get_screenshot(filename=f'{voltage}Vac___A [0W]___B [65W] {vout3}V 100Load___PortA.png', path=f'{waveforms_folder}')
      print(f'{voltage}Vac___A [0W]___B [65W] {vout3}V 100Load___PortA.png')
      waveform_counter = waveform_counter + 1
      scope2.get_screenshot(filename=f'{voltage}Vac___A [0W]___B [65W] {vout3}V 100Load___PortB.png', path=f'{waveforms_folder}')
      print(f'{voltage}Vac___A [0W]___B [65W] {vout3}V 100Load___PortB.png')
      waveform_counter = waveform_counter + 1
