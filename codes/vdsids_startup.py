...
# TEST PARAMETERS
# trigger settings
trigger_level = 0.21549          # set initial trigger level
trigger_source = 2            # trigger source CHANNEL
...
waveforms_folder = 'waveforms/Vds Ids Startup Operation'
print()
print('Vds Ids Startup Operation:')

# TEST SEQUENCE
# 90 %LoadCC, 115 %LoadCC, 230 %LoadCC, 265 %LoadCC
# 90 %LoadCR, 115 %LoadCR, 230 %LoadCR, 265 %LoadCR
# 90 0Load, 115 0Load, 230 0Load, 265 0Load
