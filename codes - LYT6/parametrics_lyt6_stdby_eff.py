...
vin_list = [90,100,110,115,120,132,180,200,230,265] # der-742

vout = 42
iout_nom = 1


soak_time = 30  # s 60 normal
...
def collect_data(vin):
    ...
    output_list = [vac, freq, vac_actual, iin, pin, pf, thd, vo1, io1, po1, vreg1, ireg1, eff, vpfc]
...
def operation():
    ...
    df_header_list = ['Vin', 'Freq (Hz)', 'Vac (VAC)', 'Iin (mA)', 'Pin (W)', 'PF', 'THD (%)', 'Vo (V)', 'Io1 (mA)', 'Po (W)', 'Vreg (%)', 'Ireg (%)', 'Eff (%)', 'Vpfc (V)'] 
