...
test_name = f"Input Current"
unit_no = "1"
unit = f"Rev C Samples_{unit_no}"
excel_name = f'{unit_no}_{vout_nom_1}V'


channel_to_trigger = 4


channel_trigger_delta = 0.1
if vout_nom_1 == 42:
    channel_trigger_delta = 0.1
if vout_nom_1 == 12:
...
def main():
    ...
    if vout_nom_1 == 12:
        scope.write("MMEM:RCL 'C:/Users/Public/Documents/Rohde-Schwarz/RTx/SaveSets/2025/DER-1081/INPUT CURRENT 12v.dfl'")
