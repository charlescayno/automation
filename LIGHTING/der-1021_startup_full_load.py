...
def main():
    ...
    # scope.write("MMEM:RCL 'C:/Users/Public/Documents/Rohde-Schwarz/RTx/SaveSets/2025/der1021_startupfl.dfl'")
    ...
    for led_load in led_load_list:
        ...
        for vin in vin_list:
            ...
            filename = f"{vin}VAC, {led_load}V, Startup FL, Iout={iout*1000}mA"
