...
class GENERAL_CONSTANTS():
    ...
    HEADER_LIST_CC_LOAD_COMPLETE = ['Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD', 'Vo (V)', 'Io (mA)', 'Po (W)', '%Ireg', 'Efficiency', 'Vbulk (V)']
    ...
    HEADER_LIST_CC_LOAD_PDEL = ['Load%', 'Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                             ...
                             'Efficiency', "VoRipple"]
    HEADER_LIST_NO_LOAD = ['Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                             'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)']
    HEADER_LIST_RBIAS_OPTIMIZATION = ['Iteration', 'Vin (VAC)', 'Freq (Hz)',
                                      'Rbias (Ohms)', 'Vbias (V)', 'VBp (V)', 'Ibias (uA)',
                                      'FL Eff (%)', '300mW_PIN (W)', '300mW_POUT (W)', '300mW Eff (%)', 'NL_PIN (W)', ]
    HEADER_LIST_LED_LOAD = ['%Dim', 'Dim (V)', 'LED (V)',
                            'Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)', '%V Reg1', '%I Reg1',
                            'Efficiency']
    HEADER_LIST_1CC_NORMAL = ['Vac (rms)', 'Freq (Hz)',
                            ...
                            'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)',
                            '%V Reg1', 'Efficiency (%)']
    HEADER_LIST_1CC = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)',
                            '%V Reg1', '%I Reg1',
                            'Total Po (W)', 'Efficiency (%)', 'Vds_max (V)']
    HEADER_LIST_2CV_1CC = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)',
                            '%V Reg1_LED', '%I Reg1_LED',
                            'Vo2_CV2 (V)', 'Io2_CV2 (mA)', 'Po2_CV2 (W)',
                            '%V Reg2_CV2', '%I Reg2_CV2',
                            'Vo3_CV1 (V)', 'Io3_CV1 (mA)', 'Po3_CV1 (W)',
                            '%V Reg3_CV1', '%I Reg3_CV1',
                            'Total Po (W)', 'Efficiency (%)', 'Vds_max (V)',
                            'ILED_mean (mA)', 'ILED_pkpk (mA)']
    HEADER_LIST_2CV_1CC_PARAMETRICS = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)',
                            '%V Reg1_LED', '%I Reg1_LED',
                            ...
                            '%V Reg3_CV1', '%I Reg3_CV1',
                            'Total Po (W)', 'Efficiency (%)', 'Vds_max (V)']
    HEADER_LIST_1CV_1CC_PARAMETRICS = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)', '%I Reg1_LED',
    ...
    HEADER_LIST_1CC_with_dimming = ['Timestamp', 'Dim (V)','ILED (mA)','Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)', '%V Reg1 LED', '%I Reg1_LED', 'Efficiency (%)']

    HEADER_LIST_1CV_1CC_PARAMETRICS_with_dimming = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)', '%I Reg1_LED',
                            'Vo2_CV2 (V)', 'Io2_CV2 (mA)', 'Po2_CV2 (W)', '%V Reg2_CV2',
                            'Total Po (W)', 'Efficiency (%)', 'Dim Freq (Hz)', 'Duty (%)']
    HEADER_LIST_2CV_1CC_with_VDS_MAX = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)',
                            '%V Reg1_LED', '%I Reg1_LED',
                            ...
                            'Vo3_CV1 (V)', 'Io3_CV1 (mA)', 'Po3_CV1 (W)',
                            '%V Reg3_CV1', '%I Reg3_CV1',
                            'Total Po (W)', 'Efficiency (%)', 'Vds_max (V)', 'Derating (%)', 'Vds_fsw (kHz)']
    HEADER_LIST_2CV_1CC_dimming = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Duty (%)', 'Vo1_LED (V)', 'Io1_LED (mA)', 'Po1_LED (W)',
                            '%V Reg1_LED', '%I Reg1_LED',
                            'Vo2_CV2 (V)', 'Io2_CV2 (mA)', 'Po2_CV2 (W)',
                            '%V Reg2_CV2', '%I Reg2_CV2',
                            'Vo3_CV1 (V)', 'Io3_CV1 (mA)', 'Po3_CV1 (W)',
                            '%V Reg3_CV1', '%I Reg3_CV1',
                            'Total Po (W)', 'Efficiency (%)']
    HEADER_LIST_2CV_1CC_cross_reg = ['Vac (rms)', 'Freq (Hz)',
                            'Vin (rms)', 'Iin (mA)', 'Pin (W)',
                            'PF', '% THD',
                            'Vo1_LED (V)', 'Io1_LED (mA)', 'Dim (%)', 'Po1_LED (W)',
                            '%V Reg1_LED', '%I Reg1_LED',
                            'Vo2_CV2 (V)', 'Io2_CV2 (mA)', 'CV2 (%)', 'Po2_CV2 (W)',
                            '%V Reg2_CV2', '%I Reg2_CV2',
                            'Vo3_CV1 (V)', 'Io3_CV1 (mA)', 'CV1 (%)', 'Po3_CV1 (W)',
                            '%V Reg3_CV1', '%I Reg3_CV1',
                            'Efficiency (%)']
    HEADER_LIST_LED_LOAD_RESISTOR_DIM = ['%Dim', 'Dim (kOhms)', 'LED (V)',
                            'Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)', '%V Reg1', '%I Reg1',
                            'Efficiency']
    HEADER_LIST_LED_LOAD_PWM_DIM = ['%Dim', 'Duty (%)', 'Dim Freq (Hz)', 'LED (V)',
                            'Vac (rms)', 'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                            'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)', '%V Reg1', '%I Reg1',
                            'Efficiency']
    HEADER_LIST_CC_LOAD_2 = ['Load%', 'Vac (rms)',	'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                             ...
                             'Overall Efficiency']
    HEADER_LIST_CC_LOAD_3 = ['Port 1 Load%', 'Port 2 Load%', 'Vac (rms)',	'Freq (Hz)', 'Vin (rms)', 'Iin (mA)', 'Pin (W)', 'PF', '% THD',
                             'Vo1 (V)', 'Io1 (mA)', 'Po1 (W)', '%V Reg1',
                             'Vo2 (V)', 'Io2 (mA)', 'Po2 (W)', '%V Reg2',
                             'Overall Efficiency']
...
class GENERAL_FUNCTIONS():
    ...
    def CREATE_PATH(self, project, test, unit):
        waveforms_folder = f'C:/Users/{self.GET_USERNAME()}/Desktop/{project}/{test}/{unit}'
    ...
    def PRINT_SOAK_TIMES(self, soak_time_initial, soak_time_per_line, soak_time_per_load):
        print()
