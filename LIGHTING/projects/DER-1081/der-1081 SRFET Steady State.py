...
# test_name = f"Steadystate Stress at {vout_nom_1}V wzoomout" # iin vds sr diode.dfl
test_name = f"Steadystate Stress" # iin vds sr diode zoomed in.dfl


unit = f"RevB_130VOR_41T_0p65_AON"
...
waveforms_folder = f"C:/Users/{username}/Documents/Charles/Work/{project_type}/{project_name}/{results_folder}/{dt_string}/{unit}/{test_name}/{vout_nom_1}V"
