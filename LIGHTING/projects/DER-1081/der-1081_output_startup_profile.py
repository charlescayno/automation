...
# test_name = f"Startup Pri VDS"
test_name = f"Output Startup Profile"
unit = f"2-final (1.2A)"
...
def main():
    ...
    scope.write("MMEM:RCL 'C:/Users/Public/Documents/Rohde-Schwarz/RTx/SaveSets/2025/DER-1081 Output Startup Profile.dfl'")
