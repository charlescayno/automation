...
test_name = "Primary Vds Ids Steady-state Waveform"
...
def main():
    ...
    print("2. Set Channel 1 to PRIMARY Vds.")
    print("3. Set Channel 2 to Ids.")
    print("===================================================================\n")
    ...
    for vin in vin_list:
        ...
        for iout in iout_list:
            ...
            filename = f"{vin}VAC_SteadyState_Io_{iout}A"
            ...
            # 3. Find trigger using user-defined settings
            ef.FIND_TRIGGER(
