...
from powi.equipment import path_maker, remove_file, move_file
...
# unit = sys.argv[1]
# waveforms_folder = f"C:/Users/ccayno/Documents/Charles/Work/DER/DER-727/Marketing Samples/1103/{unit}/"
# path = path_maker(f'{waveforms_folder}')
# excel_name = f"DER727_UNIT_{unit}"
# full_path = path + excel_name + '.xlsx'
# output_folder = f"C:/Users/ccayno/Documents/Charles/Work/DER/DER-727/Marketing Samples/1103/"
# output_path = output_folder + excel_name + '.xlsx'
# print(full_path)
...
def resistor_chart(ws_name, chart_row_location = 22):
    ...
    data_length = led_row[1] - led_row[0]
...
if __name__ == "__main__":
    global unit
    unit_list = convert_argv_to_int_list(sys.argv[1])
    for i in unit_list:
        headers("Chart")
        main(i)
        move_file(source_path=full_path, destination_path=output_path)
