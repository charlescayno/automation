    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                ...
                analog_dimming(LED = LED, vin = vin, start = start, end = end, step = step, soak = 10, delay_per_line = 10, delay_per_load = 5)
    ...
    if test in test_list:
        ...
        for LED in led_list:
            ...
            for vin in vin_list:    
                """MAX to MIN"""
                ate_gui.click(vin_dict[f"{LED}V {vin}Vac"])
                analog_dimming(LED = LED, vin = vin, start = end, end = start, step = step, soak = 10, delay_per_line = 10, delay_per_load = 5)
